...
class SimpleFacerec:
    ...
    def detect_known_faces(self, frame):
        ...
        for face_encoding in face_encodings:
            ...
            # # eğer know_face_encodings isimli liste içerisinde eğer bir eşleşme bulunur ise bulduğu ilk eşlemeyi kullan.
            # if True in matches:
            #     first_match_index = matches.index(True)
            #     name = known_face_names[first_match_index]

            # Veya bunun yerine, bilinen yüzü yeni yüze en küçük mesafeyle kullanın.
